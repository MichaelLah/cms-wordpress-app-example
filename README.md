...
- Copy `.env.local.example`, rename to `.env`
- Either `docker compose up` or create a wordpress site somewhere else
- Log into your wordpress site
- Install GraphQL plugin
- Change permalinks to be slug based
- Get graphql endpoint and update `WORDPRESS_API_URL` in `.env`.
  - Usually `https://mysite.com/grpahql` 
- `npm run dev`
- Go to `localhost:3000`. See your posts!
